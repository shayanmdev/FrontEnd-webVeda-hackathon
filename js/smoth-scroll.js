 function k() { if (document.body) { var a = document.body,
 ...
 function x(a, b, c) {
     ...
     d || (d = 1E3);
     y(b, c);
     z.push({ x: b, y: c, a: 0 > b ? 0.99 : -0.99, b: 0 > c ? 0.99 : -0.99, start: +new Date });
     if (!A) {
         var e = function() {
             for (var u = +new Date, l = 0, q = 0, n = 0; n < z.length; n++) { var f = z[n],
                     g = u - f.start,
                     C = g >= B,
                     h = C ? 1 : g / B;
 ...
 function H(a) { r || k(); var b = a.target,
         c = I(b); if (!c || a.defaultPrevented || "embed" === p.nodeName.toLowerCase() || "embed" === b.nodeName.toLowerCase() && /\.pdf/i.test(b.src)) return !0; var b = a.wheelDeltaX || 0,
         d = a.wheelDeltaY || 0;
 ...
 function I(a) { var b = [],
         c = m.scrollHeight;
     do { var d = W[X(a)]; if (d) return V(b, d);
         b.push(a); if (c === a.scrollHeight) { if (!s || m.clientHeight + 10 < c) return V(b, document.body) } else if (a.clientHeight + 10 < a.scrollHeight && (overflow = getComputedStyle(a, "").getPropertyValue("overflow"), "scroll" === overflow || "auto" === overflow)) return V(b, a) } while (a = a.parentNode) }

 function y(a, b) { a = 0 < a ? 1 : -1;
     b = 0 < b ? 1 : -1; if (Y !== a || Z !== b) Y = a, Z = b, z = [] }

 function F(a) { var b;
     a *= $;
     1 > a ? b = a - (1 - Math.exp(-a)) : (b = Math.exp(-1), a = 1 - Math.exp(-(a - 1)), b += a * (1 - b)); return b * E }
 var G = 150,
     B = 500,
     J = 150,
     D = !0,
     ...
     A = !1,
     W = {};
 setInterval(function() { W = {} }, 1E4);
 var X = function() { var a = 0; return function(b) { return b.c || (b.c = a++) } }();
